...
test('living-person media cannot become public',()=>{assert.match(model.mediaLibrary.privacyRule,/forced private/i);assert.match(mediaFn,/privateRequired/);assert.match(mediaFn,/mustPrivate\?'private'/);});
