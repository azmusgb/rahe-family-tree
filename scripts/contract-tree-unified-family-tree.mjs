...
const experienceRoot=fs.readFileSync('src/app/experience.js','utf8');
...
const treeEngine=fs.readFileSync('src/features/tree/engine.js','utf8');
const treeAdvanced=fs.readFileSync('src/features/tree/advanced.js','utf8');
