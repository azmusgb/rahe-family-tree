...
const navigation=fs.readFileSync('src/features/navigation/shell.js','utf8');
const styleRoot=fs.readFileSync('src/styles/index.css','utf8');
const mobile=fs.readFileSync('src/styles/core.css','utf8');
const density=fs.readFileSync('src/features/navigation/mobile-family-density.js','utf8');
