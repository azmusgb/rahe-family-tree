...
await mkdir('dist');
for(const f of ['index.html','v11.js','core.js','graph.js','dossiers.js','archive-views.js','traceability.js','operations.js','research-state.js','family-editor.js','shared-sync.js','family-experience.js','v12-3-controls.js','media.js','auth.js','deployment.js','v11.css','v11-nav.css','v11-2.css','v11-3.css','v11-4.css','v11-6.css','v12.css','v12-2.css','v12-3.css','v12-4.css','v12-5.css']) await copyFile(f,`dist/${f}`);
...
console.log(`Built Rahe Family Research Workbench v${buildInfo.release} · ${buildInfo.gitSha}.`);
