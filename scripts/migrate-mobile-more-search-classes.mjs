...
const excludedFiles=new Set(['scripts/migrate-mobile-more-search-classes.mjs']);
...
for(const legacy of replacements.keys())if(!counts[legacy])throw new Error(`No exact ${legacy} references found.`);
