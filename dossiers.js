...
const c001Fields=[
  {key:'child',label:'[1] Child subject',value:'Edward Ellery DeVine',supports:'CL-DV-001 · direct infant identity',notSupports:'CL-DV-002 · adult identity bridge'},
  {key:'dates',label:'[2] Recorded dates',value:'Birth: 1 Dec 1918 · Baptism: 22 Dec 1918',supports:'CL-DV-001 · chronology',notSupports:'CL-DV-002 · identity-transition mechanism'},
  {key:'parents',label:'[3] Parents named',value:'Ellery DeVine + Sarah Ferry',supports:'CL-DV-001 · parents named in record',notSupports:'CL-DV-002 · later surname transition'},
      ...
      <div data-source-inspector-main>
        ...
        <section class="panel">
          ...
          <div class="detail-columns">
            <div><h3>Establishes</h3><p>Edward Ellery DeVine; birth 1 Dec 1918 in Chicago; baptism 22 Dec 1918; parents named as Ellery DeVine and Sarah Ferry; sponsors David Fleming and Cecilia Fleming.</p></div>
            <div><h3>Does not establish</h3><p>Adult identity as William John Rahe Sr.; the mechanism of any surname transition; adoption, guardianship, stepfamily placement, or legal name change.</p></div>
          </div>
        </section>
      </div>
      <aside class="panel source-inspector-panel" data-source-inspector-panel aria-label="Evidence Inspector" aria-hidden="false">
        <div class="section-title"><div><p class="eyebrow">EVIDENCE INSPECTOR</p><h2>C001</h2></div><button type="button" class="source-inspector-close" data-source-inspector-close aria-label="Close evidence inspector">×</button></div>
        <div class="source-inspector-tabs" role="tablist" aria-label="Evidence inspector sections">
          <button type="button" role="tab" id="source-tab-summary" aria-controls="source-panel-summary" aria-selected="true" tabindex="0">Summary</button>
          <button type="button" role="tab" id="source-tab-claims" aria-controls="source-panel-claims" aria-selected="false" tabindex="-1">Claims</button>
          <button type="button" role="tab" id="source-tab-provenance" aria-controls="source-panel-provenance" aria-selected="false" tabindex="-1">Provenance</button>
