...
Live desktop inspection covered Home, People, a historical person, and Photos. Source review covered shared navigation, mobile sheet, search, branch browsing, person media, responsive composition, focus, and reduced motion. Automated browser coverage has been added for the main family and research routes; it is not equivalent to a completed manual review of every state.
