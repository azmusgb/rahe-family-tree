import{researchRoutes}from'../features/navigation/model.js';
...
function syncPageBrand(){
  ...
  document.querySelectorAll('.family-home-hero .eyebrow').forEach(element=>setText(element,'THE RAHE FAMILY'));
  document.querySelectorAll('.family-home-hero h1,.family-home-hero h2').forEach(element=>setText(element,'Our family, connected.'));
  const heroCopy=document.querySelector('.family-home-hero p:not(.eyebrow)');
