...
import{renderTreeEngine2Header,renderRelationshipFinder,renderCanonicalGraphAudit,renderResearchCommandCenterV2,renderPersonPlatformPanel,renderSourceEvidenceMatrix,renderGeographyHouseholds,installPlatformHandlers}from'./genealogy-ui.js';
...
if(!installed){
  ...
  document.addEventListener('submit',event=>{
    ...
    const familyDialog=event.target.closest?.('#relationship-dialog');
